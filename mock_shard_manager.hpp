...
ENUM(ShardError, uint16_t, OK, UNKNOWN, TIMEOUT, NOT_LEADER, INVALID_ARG, UNKNOWN_PG, UNKNOWN_SHARD);
...
public:
    ...
    virtual void create_shard(pg_id pg_owner, uint64_t size_bytes, info_cb cb) = 0;
